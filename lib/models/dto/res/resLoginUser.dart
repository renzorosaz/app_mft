...
ResLoginUser resCreateUserFromJson(String str) => ResLoginUser.fromJson(json.decode(str));

String resCreateUserToJson(ResLoginUser data) => json.encode(data.toJson());
...
class ResLoginUser {
  ...
  factory ResLoginUser.fromRawJson(String str) => ResLoginUser.fromJson(json.decode(str));
